...
| ----- | ------------------------------ | ------- | ----------- | --------- | ---------------------------------------------------------- |
| 001   | `001-auto-admit-pack-members`  | Ready   | P0 absolute | M1        | Supabase credentials                                       |
| 002   | `002-session-restore`          | Ready   | P0          | M1        | none                                                       |
| 003   | `003-extension-auth-loading`   | Ready   | P1          | M1        | none                                                       |
| 004   | `004-advanced-bunker-mode`     | Ready   | P3          | M1        | none                                                       |
| 005   | `005-mobile-auth-stability`    | Backlog | P1          | M1        | `002-session-restore`                                      |
...
| 008   | `008-mobile-auth-states`       | Backlog | P2          | M1        | `002-session-restore`, ideally `005-mobile-auth-stability` |
