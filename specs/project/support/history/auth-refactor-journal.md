...
- Mission, milestones, roadmap, tasks : [../../README.md](../../README.md)
...
- Active auth/mobile follow-up is no longer tracked here. Use [../../queue.md](../../queue.md).
...
Historical snapshot; active tracking is now in [../../queue.md](../../queue.md)
...
- `specs/project/support/architecture/overview.md` currently documents the backend as Bun + SQLite with `.runtime/pack-requests.sqlite`.
- That will become inaccurate after the Supabase migration.

Completion criteria:

- `specs/project/support/architecture/overview.md` documents Supabase as the persistent data store.
...
Le pilotage actif est maintenant dans [../../README.md](../../README.md).
