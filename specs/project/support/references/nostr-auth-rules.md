...
Pour les taches en cours, utiliser [../../queue.md](../../queue.md).
...
- la checklist `../research/remote-signer-threat-model-checklist.md` est un input de recherche, pas une norme automatique de merge;
